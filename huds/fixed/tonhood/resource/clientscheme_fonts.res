Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"Toe the Line" [$WINDOWS] // Primary font
				"name"			"Toe the Line" [!$WINDOWS] // Primary font
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"Toe the Line" [$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"Toe the Line" [$WINDOWS] // Health Font | Primary font
				"name"			"Toe the Line" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"Toe the Line" [$WINDOWS] // Ammo Font | Primary font
				"name"			"Toe the Line" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"Toe the Line" [$WINDOWS] // Damage font | Primary font
				"name"			"Toe the Line" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"Toe the Line" [$WINDOWS] // Crit damage font | Primary font
				"name"			"Toe the Line" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"Toe the Line" [$WINDOWS] // Target ID health font | Primary font
				"name"			"Toe the Line" [!$WINDOWS] // Target ID health font | Primary font
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"Toe the Line" [$WINDOWS] // Closed captions font | Secondary font
	...
	CustomFontFiles
	{
		...
		"3"
		{
			"font" "resource/fonts/ToonHUD Toe the Line Regular.ttf"
			"name" "TF2"
			"russian"
			{
				"range" "0x0000 0xFFFF"
