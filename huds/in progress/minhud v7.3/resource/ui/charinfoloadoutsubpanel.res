"Resource/UI/CharInfoLoadoutSubPanel.res"
{
	"CharInfoLoadoutSubPanel"
	{
		...
		"bgcolor_override"	"minGrayLight"
		"infocus_bgcolor_override" "minGrayLight"
		"outoffocus_bgcolor_override" "minGrayLight"
	...
	"ScoutButton"
	{
		...
		"armedBgColor_override" "44 44 44 255"
		"depressedBgColor_override" "minGray"
		"selectedBgcolor_override"		"minGray"	

		"sound_depressed"	"UI/buttonclick.wav"
		"sound_released"	"UI/buttonclickrelease.wav"
		
		"image_drawcolor"	"238 238 238 200"
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\scout"
		}			
	}			
	"SoldierButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Soldier"
		}			
	}		
	"PyroButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Pyro"
		}			
	}	
	"DemomanButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Demo"
		}			
	}		
	"HeavyButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Heavy"
		}			
	}		
	"EngieButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Engie"
		}			
	}	
	"MedicButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Medic"
		}			
	}	
	"SniperButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Sniper"
		}			
	}	
	"SpyButton"
	{
		...
		"SubImage"
		{
			...
			"enabled"		"1"
			"scaleImage"	"1"
			"image"			"replay\thumbnails\Classes\Spy"
		}			
	}
	"scout"
	{
